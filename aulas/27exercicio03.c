/*
Pedir para usuário digitar 4 notas para cada aluno, e seram 4 alunos devolvendo a média de cada.
*/
#include <stdio.h>
...
int main(void){
    ...
    for(int aluno = 0; aluno < numeroDeAlunos; aluno++){
        for(int notas = 0; notas < bimestresAnuais; notas++){
            ...
            media += notasAlunos[aluno][notas]; //soma de todas as notas do aluno
        }
        //media do aluno correspondente ao loop
        mediasAlunos[aluno] = media / bimestresAnuais;
        media = 0; //resetar para iniciar outro ciclo
